...
def build_env_context(
    ...
    if add_hint:
        parts.append(
            ...
            "Skill names are guidance labels, not callable function/tool names. "
            "When taking actions, call real tools such as browser_use/read_file/"
            "execute_shell_command, not a skill name itself.\n"
